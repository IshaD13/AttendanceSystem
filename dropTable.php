...
<body>
    <div class='wrapper'>
        ...
        <p>Please the Employee ID of the employee whose records you wish to delete.</p>
...
if(isset($_POST['EmployeeID7']))
{
 if(isset($_POST['submit'])) {
    ...
    $EmployeeID8 = "E".$EmployeeID7;
        // when user clicks the button, delete their row in the registration database
    $sql = "DELETE FROM Information WHERE EmployeeID='$EmployeeID7'";
            // inform the user if the information has been deleted from the database, and if not, list specific error  
